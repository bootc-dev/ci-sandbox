#!/usr/bin/env python3
"""Generate and store Secure Boot signing keys for composefs UKI boot.
...
The 'generate' verb creates Secure Boot keys (PK, KEK, db — RSA-2048,
10-year certs) and a GUID.
...
def generate_keys(output_dir: Path):
    """Generate Secure Boot key material."""
